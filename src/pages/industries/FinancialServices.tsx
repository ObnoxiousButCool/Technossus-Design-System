    ...
    <>
      ...
      <section id="proof" style={{ background: '#fff' }}>
        <div style={inner}>
          ...
          <div style={{ display: 'flex', alignItems: isMobile ? 'flex-start' : 'flex-end', flexDirection: isMobile ? 'column' : 'row', justifyContent: 'space-between', gap: 16, marginTop: 16, marginBottom: 40 }}>
            <div>
              <h1 style={d1()}>Results from the <span style={{ color: red }}>field.</span></h1>
              <p style={{ fontFamily: sans, fontSize: 15, color: '#5C5C5C', marginTop: 10 }}>Real outcomes from financial services organizations we've partnered with.</p>
            </div>
      ...
      <section style={{ background: dark1, position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={inner}>
          ...
          <div style={{ display: 'flex', alignItems: isMobile ? 'flex-start' : 'flex-end', flexDirection: isMobile ? 'column' : 'row', justifyContent: 'space-between', gap: 16, marginTop: 16, marginBottom: 40 }}>
            <h1 style={d1('#fff')}>More <span style={{ color: red }}>success stories.</span></h1>
