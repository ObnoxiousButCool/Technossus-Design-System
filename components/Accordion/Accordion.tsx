...
const defaultItems: AccordionItem[] = [
  ...
  },
  {
    ...
    content: {
      ...
      heading: "Find out if the idea works before you bet the quarter on it.",
      body: [
        "Objective validation matters most when the team that built the system is also the one reviewing it.",
      ],
    },
  },
  {
...
export function Accordion({
  ...
  const [mobileActive, setMobileActive] = useState(defaultActiveIndex);
